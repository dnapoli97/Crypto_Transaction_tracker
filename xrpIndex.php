/*
This file is the XRP price history. It also provides navagation to sign in/sign up page and to view crypto currency histories.
*/
    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $queryStatement = "SELECT * FROM Xrp ORDER BY day DESC";
