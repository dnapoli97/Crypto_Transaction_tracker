/*
This file is the landing page of the webapp. It provides navagation to sign in/sign up page and to view crypto currency histories.
*/
    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $queryStatement = "SELECT * FROM Bitcoin ORDER BY day DESC";
